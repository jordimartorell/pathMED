...
cross-validation may be repeated several times (**repeatsCV** parameter)
for hyperparameter tuning.

In the example data, the metadata contain the column *Response*
indicating if the patients responded to a treatment or not. The
**positiveClass** may be specified to calculate the performance metrics
considering that the positive class (e.g. diseased) is the indicated.
